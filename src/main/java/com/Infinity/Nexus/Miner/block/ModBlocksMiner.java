...
public class ModBlocksMiner {
    ...
    public static final RegistryObject<Block> CHRISTMAS_CLEAR_GLASS = registerBlock("christmas_clear_glass", () -> new GlassBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).strength(0.3f, 0.1f).sound(SoundType.GLASS).lightLevel((state) -> 5).noOcclusion().mapColor(MapColor.COLOR_GRAY)));

    public static final RegistryObject<Block> WOOD_STRUCTURE = registerBlock("wood_structure",() -> new Structure(BlockBehaviour.Properties.copy(Blocks.OAK_WOOD).requiresCorrectToolForDrops().strength(2.0f, 1.0f).sound(SoundType.WOOD).mapColor(MapColor.WOOD)));
    public static final RegistryObject<Block> STONE_STRUCTURE = registerBlock("stone_structure",() -> new Structure(BlockBehaviour.Properties.copy(Blocks.STONE).requiresCorrectToolForDrops().strength(2.0f, 3.0f).sound(SoundType.COPPER).mapColor(MapColor.COLOR_ORANGE)));
    public static final RegistryObject<Block> COPPER_STRUCTURE = registerBlock("copper_structure",() -> new Structure(BlockBehaviour.Properties.copy(Blocks.COPPER_BLOCK).requiresCorrectToolForDrops().strength(2.0f, 6.0f).sound(SoundType.METAL).mapColor(MapColor.GOLD)));
    public static final RegistryObject<Block> IRON_STRUCTURE = registerBlock("iron_structure",() -> new Structure(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).requiresCorrectToolForDrops().strength(2.0f, 4.0f).sound(SoundType.COPPER).mapColor(MapColor.TERRACOTTA_WHITE)));
    public static final RegistryObject<Block> GOLD_STRUCTURE = registerBlock("gold_structure",() -> new Structure(BlockBehaviour.Properties.copy(Blocks.GOLD_BLOCK).requiresCorrectToolForDrops().strength(2.0f, 4.0f).sound(SoundType.COPPER).mapColor(MapColor.TERRACOTTA_WHITE)));
    public static final RegistryObject<Block> QUARTZ_STRUCTURE = registerBlock("quartz_structure",() -> new Structure(BlockBehaviour.Properties.copy(Blocks.QUARTZ_BLOCK).requiresCorrectToolForDrops().strength(2.0f, 4.0f).sound(SoundType.COPPER).mapColor(MapColor.COLOR_BLACK)));
    public static final RegistryObject<Block> DIAMOND_STRUCTURE = registerBlock("diamond_structure",() -> new Structure(BlockBehaviour.Properties.copy(Blocks.DIAMOND_BLOCK).requiresCorrectToolForDrops().strength(2.0f, 5.0f).sound(SoundType.METAL).mapColor(MapColor.COLOR_BLACK)));
    public static final RegistryObject<Block> EMERALD_STRUCTURE = registerBlock("emerald_structure",() -> new Structure(BlockBehaviour.Properties.copy(Blocks.EMERALD_BLOCK).requiresCorrectToolForDrops().strength(2.0f, 5.0f).sound(SoundType.METAL).mapColor(MapColor.COLOR_YELLOW)));
    public static final RegistryObject<Block> NETHERITE_STRUCTURE = registerBlock("netherite_structure",() -> new Structure(BlockBehaviour.Properties.copy(Blocks.NETHERITE_BLOCK).requiresCorrectToolForDrops().strength(2.0f, 5.0f).sound(SoundType.METAL).mapColor(MapColor.COLOR_BLACK)));
    ...
    public static final RegistryObject<Block> CHRISTMAS_LIGHT_CRYSTAL = registerBlock("christmas_light_crystal", () -> new LightCrystal(BlockBehaviour.Properties.copy(Blocks.GLASS).strength(2.0f, 6.0f).sound(SoundType.GLASS).lightLevel((state) -> 15).noOcclusion().mapColor(MapColor.COLOR_GRAY), BlockSetType.POLISHED_BLACKSTONE, 1, true));
